...
- M_MDIconButton_
- M_MDFloatingActionButton_
- M_MDFlatButton_
- M_MDRaisedButton_
- M_MDRectangleFlatButton_
- M_MDRectangleFlatIconButton_
- M_MDRoundFlatButton_
- M_MDRoundFlatIconButton_
- M_MDFillRoundFlatButton_
- M_MDFillRoundFlatIconButton_
- M_MDTextButton_
- M_MDFloatingActionButtonSpeedDial_
...
The :class:`~M_MDIconButton.icon` parameter must have the name of the icon
...
By default, :class:`~M_MDIconButton` button has a size ``(dp(48), dp (48))``.
Use :class:`~M_BaseButton.user_font_size` attribute to resize the button:
...
By default, the color of :class:`~M_MDIconButton`
(depending on the style of the application) is black or white.
You can change the color of :class:`~M_MDIconButton` as the text color
...
The above parameters for :class:`~M_MDIconButton` apply
to :class:`~M_MDFloatingActionButton`.

To change :class:`~M_MDFloatingActionButton` background, use the
...
To change the text color of: class:`~M_MDFlatButton` use the ``text_color`` parameter:
...
.. code-block:: kv
    ...
    M_MDFlatButton:
        text: "[color=#00ffcc]M_MDFLATBUTTON[/color]"
        markup: True
...
This button is similar to the :class:`~M_MDFlatButton` button except that you
can set the background color for :class:`~M_MDRaisedButton`:

.. code-block:: kv

    M_MDRaisedButton:
        text: "M_MDRAISEDBUTTON"
        md_bg_color: 1, 0, 1, 1


.. M_MDRectangleFlatButton:
M_MDRectangleFlatButton
---------------------
...
Button parameters :class:`~M_MDRectangleFlatButton` are the same as
button :class:`~M_MDRaisedButton`:

.. code-block:: kv

    M_MDRectangleFlatButton:
        text: "M_MDRECTANGLEFLATBUTTON"
        text_color: 0, 0, 1, 1
        md_bg_color: 1, 1, 0, 1
...
Button parameters :class:`~M_MDRectangleFlatButton` are the same as
button :class:`~M_MDRectangleFlatButton`:

.. code-block:: kv

    M_MDRectangleFlatIconButton:
        icon: "android"
        text: "M_MDRECTANGLEFLATICONBUTTON"
...
.. code-block:: python
    ...
    from kivymd.app import MDApp
    from kivymd.uix.button import M_MDRectangleFlatIconButton
...
Button parameters :class:`~M_MDRoundFlatButton` are the same as
button :class:`~M_MDRectangleFlatButton`:

.. code-block:: kv

    M_MDRoundFlatButton:
        text: "M_MDROUNDFLATBUTTON"
...
Button parameters :class:`~M_MDRoundFlatIconButton` are the same as
button :class:`~M_MDRoundFlatButton`:

.. code-block:: kv

    M_MDRoundFlatIconButton:
        icon: "android"
        text: "M_MDROUNDFLATICONBUTTON"

.. M_MDFillRoundFlatButton:
M_MDFillRoundFlatButton
---------------------
...
Button parameters :class:`~M_MDFillRoundFlatButton` are the same as
button :class:`~M_MDRaisedButton`.

.. M_MDFillRoundFlatIconButton:
M_MDFillRoundFlatIconButton
-------------------------
...
Button parameters :class:`~M_MDFillRoundFlatIconButton` are the same as
button :class:`~M_MDRaisedButton`.

.. note:: Notice that the width of the :class:`~M_MDFillRoundFlatIconButton`
...
.. M_MDFloatingActionButtonSpeedDial:
M_MDFloatingActionButtonSpeedDial
-------------------------------

.. Note:: See the full list of arguments in the class
    :class:`~M_MDFloatingActionButtonSpeedDial`.
...
.. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/M_MDFloatingActionButtonSpeedDial.gif
    :align: center
...
.. code-block:: python
    ...
    from kivymd.app import MDApp
    from kivymd.uix.button import M_MDFloatingActionButtonSpeedDial
    ...
    class Example(MDApp):
        ...
        def build(self):
            screen = Screen()
            speed_dial = M_MDFloatingActionButtonSpeedDial()
...
.. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/M_MDFloatingActionButtonSpeedDial-hint.gif
    :align: center
...
.. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/M_MDFloatingActionButtonSpeedDial-hint-color.png
    :align: center
...
<M_BaseRectangularButton>
    ...
    padding: (dp(8), 0)  # For M_MDRectangleFlatIconButton
...
class M_BaseButton(
    ...
    """Custom font size for :class:`~M_MDIconButton`.
...
class M_BasePressedButton(M_BaseButton):
    """
    Abstract base class for those button which fade to around color on
    press.
    """
...
class M_BaseFlatButton(M_BaseButton):
    """
...
class M_BaseRaisedButton(CommonElevationBehavior, M_BaseButton):
    """
...
class M_BaseRoundButton(CircularRippleBehavior, M_BaseButton):
    """
...
class M_BaseRectangularButton(RectangularRippleBehavior, M_BaseButton):
    """
...
class M_MDIconButton(M_BaseRoundButton, M_BaseFlatButton, M_BasePressedButton):
...
class M_MDFlatButton(M_BaseRectangularButton, M_BaseFlatButton, M_BasePressedButton):
    pass


class M_BaseFlatIconButton(M_MDFlatButton):
...
class M_MDFloatingActionButton(
    M_BaseRoundButton, CircularElevationBehavior, M_BaseRaisedButton
):
    icon = StringProperty("android")
    """
    Button icon.
...
class M_MDRoundImageButton(M_MDFloatingActionButton):
...
class M_MDRectangleFlatButton(M_MDFlatButton):
    def update_md_bg_color(self, instance, value):
        self.text_color = self.theme_cls._get_primary_color()
...
class M_MDRoundFlatButton(M_MDFlatButton):
...
class M_MDTextButton(ThemableBehavior, Button):
...
class M_MDFillRoundFlatButton(CircularElevationBehavior, M_MDRoundFlatButton):
...
class M_MDRectangleFlatIconButton(M_BaseFlatIconButton):
...
class M_MDRoundFlatIconButton(M_MDRoundFlatButton, M_BaseFlatIconButton):
    pass


class M_MDFillRoundFlatIconButton(M_MDRoundFlatIconButton):
...
class M_BaseFloatingRootButton(M_MDFloatingActionButton):
...
class M_BaseFloatingBottomButton(M_MDFloatingActionButton, MDTooltip):
    _canvas_width = NumericProperty(0)
    _padding_right = NumericProperty(0)
    _bg_color = ListProperty()


class M_BaseFloatingLabel(
...
class M_MDFloatingBottomButton(M_BaseFloatingBottomButton):
    pass


class M_MDFloatingRootButton(M_BaseFloatingRootButton):
    pass


class M_MDFloatingLabel(M_BaseFloatingLabel):
    pass


class M_MDFloatingActionButtonSpeedDial(ThemableBehavior, FloatLayout):
    """
    :Events:
        :attr:`on_open`
    ...
    .. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/M_MDFloatingActionButtonSpeedDial-right-pad.gif
        :align: center

    .. rubric:: True

    .. image:: https://github.com/HeaTTheatR/KivyMD-data/raw/master/gallery/kivymddoc/M_MDFloatingActionButtonSpeedDial-right-pad-true.gif
        :align: center
    ...
    def on_leave(self, instance):
        ...
        if self.state == "open":
            for widget in self.children:
                if isinstance(widget, M_MDFloatingLabel) and self.hint_animation:
    ...
    def on_data(self, instance, value):
        ...
        for name_icon in value.keys():
            bottom_button = M_MDFloatingBottomButton(
                icon=name_icon,
    ...
    def on_color_icon_root_button(self, instance, value):
        self._get_count_widget(M_MDFloatingRootButton).text_color = value
    ...
    def on_bg_color_root_button(self, instance, value):
        self._get_count_widget(M_MDFloatingRootButton).md_bg_color = value
    ...
    def open_stack(self, instance):
        ...
        if self.state != "open":
            ...
            for widget in self.children:
                if isinstance(widget, M_MDFloatingBottomButton):
                ...
                elif isinstance(widget, M_MDFloatingLabel):
                    ...
                    isinstance(widget, M_MDFloatingRootButton)
    ...
    def _update_pos_buttons(self, instance, width, height):
        ...
        for widget in self.children:
            ...
            elif isinstance(widget, M_MDFloatingRootButton):
